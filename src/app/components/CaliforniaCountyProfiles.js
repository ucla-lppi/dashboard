        ...
        <div className={isMobile ? 'w-full mb-6' : 'w-[35%]'}>
          {isMobile ? (
            ...
            <div className="bg-tertiary rounded-[20px] p-6 mb-6">
              <p className="text-sm mb-4" style={{ color: '#303030' }}>
              ...
              <button
                ...
                className="bg-white font-bold text-primary px-4 py-3 text-base min-h-[48px] w-full rounded-[15px] shadow-md"
              >
                FAQ
              </button>
            </div>
        ...
        <div className={isMobile ? 'w-full' : 'w-[75%]'}>
          {isMobile && (
            ...
            <div className="bg-tertiary rounded-[20px] p-6">
              <h2 className="font-bold mb-4 text-xl" style={{ color: '#303030' }}>List of California Factsheets</h2>
          ...
          {!isMobile && (
            <>
              <h2 className="font-bold text-gray-900 mb-4 text-xl text-[28px]">List of California Factsheets</h2>
              {/* Search Bar */}
                  ...
                  {!isMobile && (
                    <div className="flex gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`relative ${isMobile ? 'h-8 px-4' : 'h-6 px-2'} shrink-0`}
                      >
